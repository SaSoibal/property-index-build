...
import { urgentPropertyAction } from "../../pages/DefaultPages/redux/urgent-property/urgentProperty.actions";
import { ENVIRONMENT } from "../../config/environment/environment";
import { t } from "i18next";
import LanguageContext from "../../context/LanguageProvider";
import Currency from "../../Helper/Currency";
function UrgentSaleProperties() {
    ...
    useEffect(() => {
        dispatch(urgentPropertyAction(activeTab));
        count = count + 1;
    }, [count, activeTab]);

    const property = useSelector(
        (state) => state.urgentPropertyState
    );
    const propertyData = property?.urgentPropertyData?.data?.website;
    ...
    return (
        <div className='latest-property mt-3'>
            <Container>
                <div className='title_area'>
                    <div className="row">
                        <div className="col-md-8 title-center">
                            <h3>{t('urgent_sale_properties')}</h3>
                ...
                <Row>
...

                    {
                        !loading && propertyData?.length == 0 && <>
                            <h3 className='text-muted text-center'>No data found</h3>
                        </>
                    }
                </Row>
            </Container>
...
export default UrgentSaleProperties
